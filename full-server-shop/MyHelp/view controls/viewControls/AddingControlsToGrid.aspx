<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="AddingControlsToGrid.aspx.cs" Inherits="_Default" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="moviesGRDVW" runat="server" AllowPaging="True" 
        ...
        BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDataBound = "moviesGRDVW_RowDataBound" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="sentiment" SortExpression="sentiment">
                <ItemTemplate>
                <asp:RadioButtonList AutoPostBack="true" ID="sentimentRBL" runat="server" Enabled="true" 
                         ...
                         <asp:ListItem Value="Hate" Text = "Hate" ></asp:ListItem>                       
                    </asp:RadioButtonList>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
